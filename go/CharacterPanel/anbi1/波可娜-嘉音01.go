...
func 安比01波可娜65嘉音01() *Initialization {
...
func 心弦夜响安比波可娜65嘉音01() *Initialization {
	// 这里设置 MainArticle 为 45（有效词条数）
	init := &Initialization{
		MainArticle: GlobalMainArticle,
		Name:        "心弦夜响安比波可娜65嘉音01",
		Condition: &Condition{
			Critical: GlobalCritical,
		},
	}
	// 初始化 CalculationModels（可包含多套计算方式，这里举例两个）
	init.CalculationModels = []*Initialization{
		心弦夜响安比波可娜65嘉音01站场(), // 模型A
		心弦夜响安比波可娜65嘉音01失衡(), // 模型B
	}
	return init
}

func 防爆者安比波可娜65嘉音01() *Initialization {
	// 这里设置 MainArticle 为 45（有效词条数）
	init := &Initialization{
		MainArticle: GlobalMainArticle,
		Name:        "防爆者安比波可娜65嘉音01",
	...
	// 初始化 CalculationModels（可包含多套计算方式，这里举例两个）
	init.CalculationModels = []*Initialization{
		防爆者安比波可娜65嘉音01站场(), // 模型A
		防爆者安比波可娜65嘉音01失衡(), // 模型B
	}
	return init
}

func 残心青囊安比波可娜65嘉音01() *Initialization {
	// 这里设置 MainArticle 为 45（有效词条数）
	init := &Initialization{
		MainArticle: GlobalMainArticle,
		Name:        "残心青囊安比波可娜65嘉音01",
		Condition: &Condition{
			Critical: GlobalCritical,
		},
	}
	// 初始化 CalculationModels（可包含多套计算方式，这里举例两个）
	init.CalculationModels = []*Initialization{
		残心青囊安比波可娜65嘉音01站场(), // 模型A
		残心青囊安比波可娜65嘉音01失衡(), // 模型B
	}
	return init
}

func 硫磺石安比波可娜65嘉音01() *Initialization {
	// 这里设置 MainArticle 为 45（有效词条数）
	init := &Initialization{
		MainArticle: GlobalMainArticle,
		Name:        "硫磺石安比波可娜65嘉音01",
	...
	// 初始化 CalculationModels（可包含多套计算方式，这里举例两个）
	init.CalculationModels = []*Initialization{
		硫磺石安比波可娜65嘉音01站场(), // 模型A
		硫磺石安比波可娜65嘉音01失衡(), // 模型B
	}
	return init
}

func 强音安比波可娜65嘉音01() *Initialization {
	// 这里设置 MainArticle 为 45（有效词条数）
	init := &Initialization{
		MainArticle: GlobalMainArticle,
		Name:        "强音安比波可娜65嘉音01",
...
func 安比21波可娜65嘉音01() *Initialization {
	// 这里设置 MainArticle 为 45（有效词条数）
	init := &Initialization{
		MainArticle: GlobalMainArticle,
		Name:        "安比21波可娜65嘉音01",
...
func 安比01波可娜65嘉音01站场() *Initialization {
	mags := []*Magnification{
		&Magnification{
	...
	init := &Initialization{
		...
		Gain: &Gain{
			...
			IncreasedDamage:          25 + 20 + 30 + 20 + 20 + 24, // 增伤（队友百分比）
...
func 安比01波可娜65嘉音01失衡() *Initialization {
	// 此模型可与模型A类似，仅作少量数值调整
	mags := []*Magnification{
		&Magnification{
			MagnificationValue: 334.4,
...
func 心弦夜响安比波可娜65嘉音01站场() *Initialization {
	mags := []*Magnification{
		&Magnification{
			MagnificationValue: 65.7 + 127.9 + 160.4 + 80.6 + 309.6*5 + 297,
			TriggerTimes:       11,
	...
	init := &Initialization{
		...
		Gain: &Gain{
			...
			IncreasedDamage:          25 + 20 + 30 + 20 + 24, // 增伤（队友百分比）
			ReductionResistance:      0,                      // 减抗（百分比）
			Vulnerable:               0,                      // 易伤（百分比）
			SpecialDamage:            0,                      // 特殊增伤（百分比）
		},
...
func 心弦夜响安比波可娜65嘉音01失衡() *Initialization {
	// 此模型可与模型A类似，仅作少量数值调整
	mags := []*Magnification{
		&Magnification{
			MagnificationValue: 334.4,
...
func 防爆者安比波可娜65嘉音01站场() *Initialization {
	mags := []*Magnification{
		&Magnification{
			MagnificationValue: 65.7 + 127.9 + 160.4 + 80.6 + 309.6*5 + 297,
			TriggerTimes:       11,
...
func 防爆者安比波可娜65嘉音01失衡() *Initialization {
	// 此模型可与模型A类似，仅作少量数值调整
	mags := []*Magnification{
		&Magnification{
			MagnificationValue: 334.4,
...
func 残心青囊安比波可娜65嘉音01站场() *Initialization {
	mags := []*Magnification{
		&Magnification{
			MagnificationValue: 65.7 + 127.9 + 160.4 + 80.6 + 309.6*5 + 297,
			TriggerTimes:       11,
...
func 残心青囊安比波可娜65嘉音01失衡() *Initialization {
	// 此模型可与模型A类似，仅作少量数值调整
	mags := []*Magnification{
		&Magnification{
			MagnificationValue: 334.4,
...
func 硫磺石安比波可娜65嘉音01站场() *Initialization {
	mags := []*Magnification{
		&Magnification{
			MagnificationValue: 65.7 + 127.9 + 160.4 + 80.6 + 309.6*5 + 297,
			TriggerTimes:       11,
...
func 硫磺石安比波可娜65嘉音01失衡() *Initialization {
	// 此模型可与模型A类似，仅作少量数值调整
	mags := []*Magnification{
		&Magnification{
			MagnificationValue: 334.4,
...
func 强音安比波可娜65嘉音01站场() *Initialization {
	mags := []*Magnification{
		&Magnification{
			MagnificationValue: 65.7 + 127.9 + 160.4 + 80.6 + 309.6*5 + 297,
			TriggerTimes:       11,
...
func 强音安比波可娜65嘉音01失衡() *Initialization {
	// 此模型可与模型A类似，仅作少量数值调整
	mags := []*Magnification{
		&Magnification{
			MagnificationValue: 334.4,
...
func 安比21波可娜65嘉音01站场() *Initialization {
	mags := []*Magnification{
		&Magnification{
			MagnificationValue: 65.7 + 127.9 + 160.4 + 80.6 + 309.6*5 + 297,
			TriggerTimes:       11,
...
func 安比21波可娜65嘉音01失衡() *Initialization {
	// 此模型可与模型A类似，仅作少量数值调整
	mags := []*Magnification{
		&Magnification{
			MagnificationValue: 334.4,
