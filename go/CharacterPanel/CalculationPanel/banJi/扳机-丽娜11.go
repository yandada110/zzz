...
func 安比01扳机0拘缚者丽娜11() *Initializations {
	name := "安比01扳机0拘缚者丽娜11"
...
func 安比01扳机1拘缚者丽娜11() *Initializations {
	name := "安比01扳机1拘缚者丽娜11"
	init := &Initializations{
		Name:       name,
		NumberFour: common.Critical,
...
func 安比01扳机11丽娜11() *Initializations {
	name := "安比01扳机11丽娜11"
	init := &Initializations{
		Name:       name,
		NumberFour: common.ExplosiveInjury,
	...
	init.InitializationBase1(Role.BanJi(), arms.SuoHunYingMou(false))
	// 初始化角色增益
	init.InitializationRole([]*Role.BuffCharacter{Role.BanJi11(), Role.LiNa11()})
...
func 安比01扳机21丽娜11() *Initializations {
	name := "安比01扳机21丽娜11"
	init := &Initializations{
		Name:       name,
		NumberFour: common.ExplosiveInjury,
	...
	init.InitializationBase1(Role.BanJi(), arms.SuoHunYingMou(false))
	// 初始化角色增益
	init.InitializationRole([]*Role.BuffCharacter{Role.BanJi21(), Role.LiNa11()})
...
func 安比01扳机0德玛拉丽娜11() *Initializations {
	name := "安比01扳机0德玛拉丽娜11"
	init := &Initializations{
		Name:       name,
		NumberFour: common.ExplosiveInjury,
	...
	// 初始化角色增益
	init.InitializationRole([]*Role.BuffCharacter{Role.LiNa11()})
...
func 安比01扳机0裁纸刀丽娜11() *Initializations {
	name := "安比01扳机0裁纸刀丽娜11"
	init := &Initializations{
		Name:       name,
		NumberFour: common.ExplosiveInjury,
