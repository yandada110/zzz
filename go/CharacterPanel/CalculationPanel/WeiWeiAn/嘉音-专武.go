...
func 简01薇薇安01嘉音00() *Initializations {
	name := "简01薇薇安01嘉音00"
...
func 柳01薇薇安0双生嘉音00() *Initializations {
	name := "柳01薇薇安0双生嘉音00"
	init := &Initializations{
		Name:       name,
		NumberFour: common.Proficient,
	...
	init.Initializations = []*Initialization{
		{
			Magnifications: MagnificationBase双生1(),
			Name:           name + "-站场",
			Gain:           &Gain{},
			Output:         &Output{},
			CurrentPanel:   &CurrentPanel{},
...
func 简01薇薇安0大月卡嘉音00() *Initializations {
	name := "简01薇薇安0大月卡嘉音00"
	init := &Initializations{
		Name:       name,
		NumberFour: common.Proficient,
	...
	// 初始化基础数值
	init.InitializationBase0命(Role.WeiWeiAn(), arms.ChuDianCunCai(true, true))
	// 初始化角色增益
	init.InitializationRole([]*Role.BuffCharacter{Role.JiaYin00()})
...
func 柳01薇薇安0大月卡嘉音00() *Initializations {
	name := "柳01薇薇安0大月卡嘉音00"
	init := &Initializations{
		Name:       name,
		NumberFour: common.Proficient,
