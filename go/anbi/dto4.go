...
// 0+1安比
func NewInitialization7() *Initialization {
	...
	return &Initialization{
		...
		Basic: &Basic{
			BasicAttack:              714 + 929, // 基础攻击力（角色+专武）
		...
		Gain: &Gain{
			AttackValue:              316,            // 攻击力值增加(2号位，副词条)
			AttackValue2:             0,              // 攻击力值增加(嘉音，露西，凯撒增益)
			...
			IncreasedDamage:          25 + 20 + 20.2, // 增伤（队友百分比）
