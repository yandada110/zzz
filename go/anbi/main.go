...
func (i *Initialization) ReductionResistanceArea(magnification *Magnification) {
	i.Output.ReductionResistanceArea = 1 + (magnification.IncreasedDamage+i.CurrentPanel.ReductionResistance)/100
}
...
func NewInitialization() *Initialization {
	magnifications := []*Magnification{
		...
		&Magnification{
			Name:                "123",
			MagnificationValue:  123,
			TriggerTimes:        123,
			IncreasedDamage:     123,
			ReductionResistance: 213,
			SpecialDamage:       123,
		},
	}
	return &Initialization{
		...
		Basic: &Basic{
			BasicAttack:              123,
			BasicCritical:            50,
			BasicExplosiveInjury:     123,
			BasicIncreasedDamage:     123,
			BasicReductionResistance: 123,
		},
		Gain: &Gain{
			AttackValue:              12,
			AttackPowerPercentage:    12,
			AttackInternalPercentage: 12,
			Critical:                 12,
			ExplosiveInjury:          12,
			IncreasedDamage:          12,
			ReductionResistance:      12,
			Vulnerable:               0,
			SpecialDamage:            0,
		},
		Defense: &Defense{
